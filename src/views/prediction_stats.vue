...
<!--        </div>-->
        <CRow>
            <CCol lg="6" style="height: 750px; width: 50%!important; background: white; padding: 40px; padding-top: 20px;">
                ...
                <div class="totalMatches score_stats" style="display: flex; font-weight: 600; font-size: 12px;">
                    ...
                    <div style="flex: 1; text-align: center;">
                        ...
                        <p v-else class="value">{{this.score_stats.score0_15.score30}} ({{(this.score_stats.score0_15.score30/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score16_30.score30 === 0" class="percent">{{this.score_stats.score16_30.score30}}</p>
                        <p v-else class="value">{{this.score_stats.score16_30.score30}} ({{(this.score_stats.score16_30.score30/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score31_45.score30 === 0" class="value">{{this.score_stats.score31_45.score30}}</p>
                        <p v-else class="value">{{this.score_stats.score31_45.score30}} ({{(this.score_stats.score31_45.score30/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score46_60.score30 === 0" class="percent">{{this.score_stats.score46_60.score30}}</p>
                        <p v-else class="value">{{this.score_stats.score46_60.score30}} ({{(this.score_stats.score46_60.score30/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score61_75.score30 === 0" class="value">{{this.score_stats.score61_75.score30}}</p>
                        <p v-else class="value">{{this.score_stats.score61_75.score30}} ({{(this.score_stats.score61_75.score30/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score76_90.score30 === 0" class="percent">{{this.score_stats.score76_90.score30}}</p>
                        <p v-else class="value">{{this.score_stats.score76_90.score30}} ({{(this.score_stats.score76_90.score30/this.matches_found*100).toFixed(0)}}%)</p>
                    </div>
                    <div style="flex: 1; text-align: center;">
                    ...
                    <div style="flex: 1; text-align: center;">
                        ...
                        <p v-else class="value">{{this.score_stats.score0_15.score03}} ({{(this.score_stats.score0_15.score03/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score16_30.score03 === 0" class="percent">{{this.score_stats.score16_30.score03}}</p>
                        <p v-else class="value">{{this.score_stats.score16_30.score03}} ({{(this.score_stats.score16_30.score03/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score31_45.score03 === 0" class="value">{{this.score_stats.score31_45.score03}}</p>
                        <p v-else class="value">{{this.score_stats.score31_45.score03}} ({{(this.score_stats.score31_45.score03/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score46_60.score03 === 0" class="percent">{{this.score_stats.score46_60.score03}}</p>
                        <p v-else class="value">{{this.score_stats.score46_60.score03}} ({{(this.score_stats.score46_60.score03/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score61_75.score03 === 0" class="value">{{this.score_stats.score61_75.score03}}</p>
                        <p v-else class="value">{{this.score_stats.score61_75.score03}} ({{(this.score_stats.score61_75.score03/this.matches_found*100).toFixed(0)}}%)</p>
                        <p v-if="this.score_stats.score76_90.score03 === 0" class="percent">{{this.score_stats.score76_90.score03}}</p>
                        <p v-else class="value">{{this.score_stats.score76_90.score03}} ({{(this.score_stats.score76_90.score03/this.matches_found*100).toFixed(0)}}%)</p>
                    </div>
                    <div style="flex: 1; text-align: center;">
